          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground">
                The system uses a high-performance Redis-compatible in-process store with atomic snapshots.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3 p-4 border rounded-lg bg-primary/5">
                    ...
                    <div>
                      <p className="font-semibold text-lg">Inline Redis + Snapshot</p>
                      <p className="text-xs text-muted-foreground">Single-instance low-latency store</p>
                    </div>
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Hot data remains in memory; an atomic mounted snapshot preserves progression across restarts.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-3 border rounded-lg bg-muted/30">
                    <p className="text-sm">
                      <strong>Mode:</strong> Persistent single-instance snapshot
                    </p>
                    <p className="text-xs text-muted-foreground mt-1">
                      Configure <code>V0_REDIS_SNAPSHOT_PATH</code> on a durable volume. The reference Compose profile uses <code>/app/state/redis-snapshot.json</code>.
                    </p>
                  </div>
                </div>
              </div>
