        ...
        <TabsContent value="configure" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Production continuity for the single runtime instance</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <p className="text-sm text-blue-900 dark:text-blue-100">
                  <strong>Active mode:</strong> Low-latency in-process Redis semantics with atomic snapshot persistence.
                </p>
              </div>

              <div className="space-y-2">
                <Label htmlFor="redis-url">Snapshot path</Label>
                <Input
                  id="redis-url"
                  value="Configured server-side with V0_REDIS_SNAPSHOT_PATH"
                  readOnly
              ...
              <div className="text-sm text-muted-foreground space-y-2">
                <p><strong>Development:</strong> Snapshot defaults to <code>.v0-data/redis-snapshot.json</code>.</p>
                <p><strong>Production:</strong> Mount the configured path on durable storage and run exactly one application replica.</p>
                <p>The readiness endpoint verifies that snapshots complete and are not stale.</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
